...
/**
 * Animates the given text within the specified container element.
 * @param text The text to animate.
 * @param container The HTML element that will contain the animated text.
 */
...
/**
 * Extracts the pixels from the given input data, creating Pixel objects for each non-transparent pixel.
 * @param inputData The input data containing text and styling information.
 * @returns An array of Pixel objects representing the text.
 */
...
/**
 * Draw the given pixels on the canvas context, using 'lighter' composite mode for additive blending.
 * @param ctx The canvas rendering context.
 * @param pixels The array of pixels to draw.
 */
...
/**
 * Animates the given pixels along the specified path on the canvas context.
 * @param ctx The canvas rendering context.
 * @param pixels The array of pixels to animate.
 * @param path The path along which the pixels will move.
 */

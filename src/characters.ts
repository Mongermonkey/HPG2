...
import { MainChara, Wizard } from "./maincharacter";
...
export async function friendshipWheel(chara: MainChara<'Wizard'>, sureFriend?: boolean, senior?: boolean): Promise<void>
{
    ...
    {        
        ...
        chara.alignement = 'phoenix_order';
...
{
    const students = characterlist.filter(c => c.role === 'Student') as Character<'Student'>[];

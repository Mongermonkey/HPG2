...
import { WheelSegment } from '../../wheel_magic/WheelSegment';
import * as chitchat from "../../dialogues/year-one-dialogues";
import { Baseclass, CustomClass, Pet } from '../../maincharacter';

/**
 * Attend the fourth year at Hogwarts.
 */
export async function attend(chara: CustomClass['Wizard']): Promise<CustomClass['Wizard']>
{
    // tuttecose del quarto anno
